    ...
    <div class="mt-8">
        ...
        <div class="overflow-x-auto">
            ...
            <thead class="bg-gray-200 text-left">
                <tr>
                    <th wire:click="sortBy('name')" class="border border-gray-500 px-4 py-2 cursor-pointer hover:bg-gray-300">
                    ...
                    <th wire:click="sortBy('email')" class="border border-gray-500 px-4 py-2 cursor-pointer hover:bg-gray-300">
                        <div class="flex items-center">
                            Email
                            @if($sortField === 'email')
                                <span class="ml-1">
                    ...
                    <th wire:click="sortBy('end_status')" class="border border-gray-500 px-4 py-2 cursor-pointer hover:bg-gray-300">
                        <div class="flex items-center">
                            Status
                    ...
                    <th wire:click="sortBy('created_at')" class="border border-gray-500 px-4 py-2 cursor-pointer hover:bg-gray-300">
                        <div class="flex items-center">
                            Reg Date
            ...
            <tbody class="bg-white">
                ...
                <tr class="hover:bg-sky-200 cursor-pointer">
                    <td onclick="window.location='{{ route('students.show', $registration->student->id) }}'" class="border border-gray-500 px-4 py-2 cursor-pointer">
